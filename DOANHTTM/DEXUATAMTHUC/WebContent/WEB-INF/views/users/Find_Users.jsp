...
<body>
			...
			<div class="container">
				<div>
					<a class="navbar-brand"
						href="${pageContext.request.contextPath}/users/Main.htm">KITCHEN</a>
				</div>
				...
				<div class="collapse navbar-collapse" id="menu">
					<ul class="navbar-nav mx-auto">
						<li class="nav-item"><a class="nav-link" aria-current="page"
							href="${pageContext.request.contextPath}/users/Main.htm">Trang
								Chủ</a></li>
						...
						<li class="nav-item dropdown"><a
							...
							<ul class="dropdown-menu">
								...
								<li><a class="dropdown-item"
									href="${pageContext.request.contextPath}/users/mainfood.htm">Danh
										Mục Món Ăn</a></li>

								<li><a class="dropdown-item"
									href="${pageContext.request.contextPath}/users/suggest.htm">Gợi
										Ý Hôm Nay</a></li>
								<li><a class="dropdown-item"
									href="${pageContext.request.contextPath}/users/findmeal.htm">Tìm
										Kiếm Món Ăn</a></li>
								<li><a class="dropdown-item"
									href="${pageContext.request.contextPath}/users/famousfood.htm">Món
										Ăn Phổ Biến</a></li>

								<li><a class="dropdown-item" href="${pageContext.request.contextPath}/users/search_user.htm">Tìm Kiếm Người Dùng</a></li>
								<li><a class="dropdown-item"
									href="${pageContext.request.contextPath}/users/createmeal.htm">Tạo
										Món Ăn</a></li>
							</ul></li>
					...
					<div class="dropdown">
						<button onclick="showDropdown()" class="login-btn">
							<i class="fa-solid fa-user"></i> ${sessionScope.nameuser}
						</button>
						<div id="myDropdown" class="dropdown-content">
							<a href="${pageContext.request.contextPath}/users/acountuser.htm">Tài
								Khoản</a> <a
								href="${pageContext.request.contextPath}/users/Login.htm">Logout</a>
						</div>
	...
	<main>
		...
		<div class="container">
			<div class="col-md-12">
				<h1 class="text-center">Tìm Kiếm Người Dùng</h1>
				<form class="example" action="/action_page.php">
					<input type="text" id="myInput" placeholder="Nhập mã người dùng..."
						name="search">
					<button type="submit">
    ...
    <tbody>
        <c:forEach items="${ListUser}" var="USER">
            <c:if test="${USER.maUser != sessionScope.maUser}">
                    ...
                    <tr>
                        ...
                        <td>${USER.email}</td>
                        <td>
                            <a href="${pageContext.request.contextPath}/users/detail_user${USER.maUser}.htm">
